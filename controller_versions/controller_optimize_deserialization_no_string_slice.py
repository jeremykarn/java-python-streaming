...
def _deserialize_input(input_str, si, ei):
    ...
    if schema == 'bag':
        return _deserialize_collection(input_str, TYPE_BAG, si+3, ei-3)
    elif schema == 'tuple':
        return _deserialize_collection(input_str, TYPE_TUPLE, si+3, ei-3)
    elif schema == "map":
        return _deserialize_collection(input_str, TYPE_MAP, si+3, ei-3)
    else:
